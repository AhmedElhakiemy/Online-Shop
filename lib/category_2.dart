...
class category_2 extends StatelessWidget
{
  @override
    ...
    return Scaffold(
      ...
      body:ListView.builder(
        ...
        itemBuilder: (context, index)
        {
          ...
          if(Provider.of<MyProvider>(context,listen:false).items[index]['id']>4 && Provider.of<MyProvider>(context,listen:false).items[index]['id']<=7)
          {
            ...
            return ListTile(
              ...
              leading: IconButton(onPressed: (){},icon:Image.network(Provider.of<MyProvider>(context,listen:false).items[index]['image'])),
              trailing: Row(
